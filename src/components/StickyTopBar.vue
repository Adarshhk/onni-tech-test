<template>
    <div class="sticky top-0 z-50 bg-[#06090F] flex justify-between md:px-24 px-3 py-1">
        <div class="flex items-center gap-1 text-white ">
            ...
            <a class="text-[16px] font-[400]" href="mailto:info@omnitechalgo.com">info@omnitechalgo.com</a>
        </div>

        <div class="lg:flex gap-1 items-center hidden ">
...
import tg from '/src/assets/svg/social/tg.svg'
import yt from '/src/assets/svg/social/yt.svg'

const social = [
    { icon: ig, link: 'https://www.instagram.com/omnitechalgo' },

    { icon: wp, link: 'https://wa.me/919823058953' },
